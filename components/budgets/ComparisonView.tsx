            ...
            <table className="w-full max-w-3xl border-collapse text-xs">
              <thead>
                <tr className="border-b border-slate-200 text-slate-500">
                  <th className="px-2 py-1 text-left">LB</th>
              ...
              <tbody>
                {y.rows.map((r) => (
                  <tr key={r.lineId} className="border-b border-slate-50">
                    <td className="px-2 py-1">
                      <span className="font-mono text-slate-400">{r.code}</span> {r.label}
                    </td>
                ...
                <tr className="border-t border-slate-300 font-medium">
                  <td className="px-2 py-1">Total année</td>
